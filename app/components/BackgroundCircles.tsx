...
export const BackgroundCircles = () => {
  return (
    ...
    >
      <div className="absolute border-none border border-[#333333] rounded-full h-[200px] w-[200px] mt-52 animate-ping " />
      ...
      <div className="rounded-full border border-[#36b2ed] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
