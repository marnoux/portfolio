...
export const Experience = () => {
  ...
  const experience = [
    ...
    {
      name: 'DataSnipper',
      fileName: 'datasnipper',
      link: 'https://www.linkedin.com/company/datasnipper/',
      startDate: '2024-05-01',
      endDate: '',
      role: 'Senior Frontend Developer',
      points: [
        'Building and maintaining a modern data processing platform for audit professionals',
        'Implementing robust data processing pipelines with React and TypeScript',
        'Collaborating with cross-functional teams to deliver high-quality features',
        'Contributing to frontend architecture decisions and best practices',
        'Optimizing application performance and user experience',
        'Mentoring team members and conducting code reviews',
        'Participating in agile ceremonies and sprint planning',
        'Ensuring code quality through comprehensive testing and documentation',
      ],
      tech: ['react', 'typescript', 'javascript', 'html5', 'css3'],
    },
  ];
  ...
  return (
    <div className="h-screen md:flew-row relative mx-auto flex flex-col items-center justify-evenly overflow-y-hidden px-10 text-left">
      ...
      <motion.div className="flex snap-x snap-mandatory space-x-5 h-[85vh] mt-20 overflow-x-scroll overflow-y-hidden lg:max-w-[50vw] w-[80vw] scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#36b2ed]">
