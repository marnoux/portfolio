...
export const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        'A health tracker app that I built to practice working with React and Redux. The app allows users to track their daily water intake and exercise. I also implemented a calendar to display the user data and a chart to visualize their progress. This project helped me learn more about state management and data visualization in React.',
