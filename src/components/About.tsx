  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex-shrink-0 sm:mb-[2vh]"
        viewport={{ once: true }}
      >
        <Image
          alt="Gif of developer coding"
          className="w-56 h-56 mt-[24vh] md:mt-[-10vh] lg:mt-20 rounded-full object-cover md:rounded-lg md:w-64 md:h-64 xl:w-80 xl:h-80"
          src="/developer.gif"
          height={480}
          width={360}
        />
      ...
      <div className="space-y-10 w-screen px-0 md:px-10 relative z-20 mt-4 md:mt-20 lg:mt-20 flex snap-x snap-mandatory overflow-y-scroll overflow-x-hidden scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#37c0ff74] md:overflow-y-hidden">
        <div className="scrollMask text-base space-y-4 border-solid shadow-sm text-ellipsis lg:h-[40vh]">
